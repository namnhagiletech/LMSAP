...
import "./index.scss";
import ProgressComon from "../../components/ProgressComon";
        ...
        <>
              ...
              <thead>
                <tr>
                  <th className="font-bold">
                    <span className="text-[14px] text-[#111] opacity-100  special">
                      SUBJECT
                    </span>
                  </th>
          ...
          <div className="mypage__newest">
                ...
                <tr>
                  ...
                  <td>
                    <p className="text-[#231815] font-bold">
                      7
                      <span className="text-[#A5A072] text-[7px] ml-2">
                        点/10
                      </span>
                    </p>
                  </td>
            ...
            >
              <ButtonCommon
                title="過去のテスト結果"
                type="button milk special-semi-brown shadow"
              />
            </div>
          </div>
          <div className="mt-12">
        ...
        <div className="mypage__statistical max-w-[360px] m-auto">
          <ul>
            <li
              ...
              className={
                activeTab === "national-exam" ? "active national-exam" : ""
              }
            >
              全国統一模試
            </li>
          ...
          <div
            className={`mypage__statistical--tab  ${
              activeTab === "national-exam" ? "active" : ""
            }`}
          >
            <table>
              <thead>
                <tr>
                  <th
                    className={
                      activeTab === "national-exam" ? "national-exam-bg" : ""
                    }
                  >
                    受験日
                  </th>
              ...
              <tbody>
                ...
                <tr
                  className={`bg-white special ${
                    showFullScores ? "h-auto" : "hidden"
                  }`}
                >
                  <td colSpan={2}></td>
                  <td colSpan={3}>
            ...
            <table>
              <thead>
                <tr>
                  <th
                    className={
                      activeTab === "trial-exam" ? "trial-exam-bg" : ""
                    }
                  >
                    受験日
                  </th>
              ...
              <tbody>
                ...
                <tr
                  className={`bg-white ${showFullScores ? "h-auto" : "hidden"}`}
                >
                  <td></td>
                  <td colSpan={3}>
                    <div className="statistical flex items-center justify-around">
          ...
          >
            <table>
              <thead>
                <tr>
                  <th
                    className={activeTab === "mini-test" ? "mini-test-bg" : ""}
                  >
                    受験日
                  </th>
                  <th
